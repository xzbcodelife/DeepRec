...
from tensorflow.python.training.adagrad_decay import AdagradDecayOptimizer
from tensorflow.python.training.adagrad_decay_v2 import AdagradDecayOptimizerV2
