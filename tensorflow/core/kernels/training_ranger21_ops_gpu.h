...
#ifndef TENSORFLOW_CORE_KERNELS_TRAINING_RANGER21_OPS_GPU_H_
#define TENSORFLOW_CORE_KERNELS_TRAINING_RANGER21_OPS_GPU_H_
...
// template <typename T>
// struct ApplyRanger21<GPUDevice, T> {
...
//                     int64 inner_dim, bool use_adaptive_grad_clipping,
...
struct KvSparseApplyRanger21 {
  Status operator()(const Device& d, EmbeddingVarGPU<Tindex, T>* var,
...
#endif  // TENSORFLOW_CORE_KERNELS_TRAINING_RANGER21_OPS_GPU_H_
